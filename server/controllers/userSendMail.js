...
`,
    ...
    transporter.sendMail(mailOptions, function(error, info){
        if (error) {
            ...
            // perhaps by logging it or notifying an administrator.
        } else {
            console.log('Email sent: ' + info.response);
            // You could potentially send a success response back to the client here 
            // if you included 'res' in the function parameters and wanted confirmation.
            // However, for signup, the initial response is sent before email sending completes.
        }
    });
}